if (location.pathname.match("videos/new")){
  document.addEventListener("DOMContentLoaded", () => {
    const inputElement = document.getElementById("videos_tag_tag_name");
    inputElement.addEventListener("keyup", () => {
      const keyword = document.getElementById("videos_tag_tag_name").value;
        ...
        if (XHR.response) {
          ...
          tagName.forEach((tag) => {
            ...
            clickElement.addEventListener("click", () => {
              document.getElementById("videos_tag_tag_name").value = clickElement.textContent
              clickElement.remove();
            });
          });
        };
